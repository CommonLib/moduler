...
public class AppUtil {
     ...
     * @return
     */
    public int getVersionCode(PackageManager packageManager, String packageName) {
     ...
     * @return
     */
    public String getVersionName(PackageManager packageManager, String packageName) {
        PackageInfo packageInfo;
        String versionName = "";
        try {
            packageInfo = packageManager.getPackageInfo(packageName, 0);
